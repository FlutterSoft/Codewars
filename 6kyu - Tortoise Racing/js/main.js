...
// divide g by (v2-v1)
// times that by 60 to get minutes
// get seconds minutes by doing that - the math.floor   then * 60
...
function race(v1, v2, g) {
    ...
    let decimalTimeString = ( g / (v2-v1) )
    let n = new Date(0,0)
    n.setSeconds(+decimalTimeString * 60 * 60)
    let timeString = (n.toTimeString().slice(0, 8))
